...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	// Imports
	var server_ts_1 = __webpack_require__(391);
	// Start server
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Server setup
	var serverConfig = config_ts_1.config.servers.webapps;
	exports.server = express();
	// Setup statics
	var webappsPath = path.join(process.cwd(), 'src/setup/webapps/src');
	exports.server.use(config_ts_1.config.httpRoutes.webapps.path, express.static(webappsPath));
	// Start function
