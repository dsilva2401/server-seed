...
/***/ function(module, exports, __webpack_require__) {
	...
	function startServer() {
	    exports.server.listen(8000, function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	// Imports
	var views_ts_1 = __webpack_require__(85);
	var api_ts_1 = __webpack_require__(86);
	var auth_ts_1 = __webpack_require__(87);
	var statics_ts_1 = __webpack_require__(88);
	// Export setup routers function
	function setupRouters(server) {
	    api_ts_1.setupAPI(server);
	    auth_ts_1.setupAuth(server);
	    statics_ts_1.setupStatics(server);
	    views_ts_1.setupViews(server);
	}
	...
	function setupStatics(server) {
	    ...
	    router.all('*', function (req, res, next) {
	        /**
	            ...
	            3. Response request
	        */
	        res.end('Calling statics');
	    });
	    // Add router to server
	    server.use('/statics', router);
	}
	exports.setupStatics = setupStatics;
